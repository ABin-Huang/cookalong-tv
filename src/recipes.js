...
const RECIPES = [
  { id: "tomato-basil-pasta", name: "Tomato Basil Pasta", diet: ["vegetarian", "vegan"], prepTimeMinutes: 20, serves: 2, steps: [
  ...
  { id: "vegetable-stir-fry", name: "Vegetable Stir Fry", diet: ["vegetarian", "vegan", "gluten-free"], prepTimeMinutes: 15, serves: 2, steps: [
  ...
  { id: "garlic-chicken-rice", name: "Garlic Chicken Rice", diet: [], prepTimeMinutes: 35, serves: 3, steps: [
  ...
  { id: "fluffy-french-toast", name: "Fluffy French Toast", diet: ["vegetarian"], prepTimeMinutes: 15, serves: 2, steps: [
...
function recipeSummary(recipe) {
  return { id: recipe.id, name: recipe.name, diet: recipe.diet, prepTimeMinutes: recipe.prepTimeMinutes, serves: recipe.serves, stepCount: recipe.steps.length };
}
